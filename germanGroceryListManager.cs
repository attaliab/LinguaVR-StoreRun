...
public class germanGroceryListManager : MonoBehaviour
{
...
// Text Component
    ...
    public GameObject[] completionEnglishItems;
        ...
        germanRandomNumber randList = GroceryList.GetComponent<germanRandomNumber>();
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            textmeshpro_item_text.text = foodList.germanStrings[numIndex];
