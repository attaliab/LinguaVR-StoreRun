...
public class spanishScoreCheck : MonoBehaviour
{
    ...
    private spanishGroceryListManager groceryList;
    ...
    void Awake()
    {
        groceryList = GroceryList.GetComponent<spanishGroceryListManager>();
        if (groceryList != null)
        {
    ...
    void OnTriggerEnter(Collider otherCollider)
    {
        ...
        List <string> spanishList = foodList.spanishStrings;
...
// Check if the collider is on the JSON list
        if(spanishList.Contains(colliderName))
        {
