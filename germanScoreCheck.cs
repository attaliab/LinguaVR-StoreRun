...
public class germanScoreCheck : MonoBehaviour
{
    ...
    private germanGroceryListManager groceryList;
    ...
    void Awake()
    {
        groceryList = GroceryList.GetComponent<germanGroceryListManager>();
        if (groceryList != null)
        {
    ...
    void OnTriggerEnter(Collider otherCollider)
    {
        ...
        List <string> germanList = foodList.germanStrings;
...
// Check if the collider is on the JSON list
        if(germanList.Contains(colliderName))
        {
